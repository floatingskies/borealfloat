...
"$SCRIPT_DIR/register-plasma-wallpapers.sh" /usr/share/backgrounds/Auveiss-Modified auveiss-modified
"$SCRIPT_DIR/register-plasma-wallpapers.sh" /usr/share/backgrounds/Nature nature