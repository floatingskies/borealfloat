...
# Remove the MOTD launchers and binaries baked into the Aurora/Bluefin/Bazzite
# base images so no update/tip banner is shown on login for bash, zsh or fish.
#
